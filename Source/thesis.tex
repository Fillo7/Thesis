...
\begin{figure}
    ...
    __kernel void directCoulombSum(MEMORY_TYPE float4* kernelData) 
    ...
    \end{lstlisting}
    \caption{Parameter which affects memory placement of \textit{kernelData} variable.}
    \label{constant_memory}
\end{figure}
