...
chapter presents several scenarios of the new framework utilization.
...
This example demonstrates tuning of a kernel which performs summation of floating-point numbers contained in a single array.
