...
\lstset
{
    ...
    emph=[2]{size\_t, uint32\_t, PlatformIndex, DeviceIndex, ComputeAPI},
...
In order to access the API methods, tuner object has to be created. There are currently three versions of tuner constructor available
