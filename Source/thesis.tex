...
\begin{itemize}
    \item execution of code which was tuned offline for different hardware and samples resolution (so it is suboptimal with current setup)
    \item execution of code which was tuned offline for utilized hardware and samples resolution
